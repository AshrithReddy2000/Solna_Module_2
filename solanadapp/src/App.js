...
export default function App() {
  ...
  const CreateKeyPair = async ()=>
  {
   ...
   try
   {
    await connection.requestAirdrop(new PublicKey(keypair.publicKey), 2 * LAMPORTS_PER_SOL); 
    ...
    <div className="w-full h-screen">
      <nav className="w-full h-[100px] bg-black flex  justify-between items-center px-4 ">
        <ul className="text-white font-serif flex  justify-center items-center">
            ...
            <li className="mr-4 px-2">Home</li>
            <li className="mr-4 px-2">About</li>
            <li className="mr-4 px-2">Test</li>
        </ul>
      ...
      <div className=" w-[600px] mx-auto border-blue-300 border-2 h-[300px] py-8 px-8 mt-4 rounded-lg ">
        <form className="flex flex-col justify-start items-start">
         <label className="py-4">From add : <input type="text" value={Fromadd}  readOnly className="w-[400px]"></input></label>
         <label className="py-3">To add : <input type="text" value={Toadd} readOnly className="w-[400px]"></input></label>
